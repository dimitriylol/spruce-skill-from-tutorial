...
declare module '@sprucelabs/spruce-core-schemas/build/.spruce/schemas/core.schemas.types' {
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface SaveCatValuesEmitTargetAndPayload {
			
				/** Source. */
				'source'?: SpruceSchemas.SpruceEventUtils.v2021_09_13.EventSource| undefined | null
				
				'payload': SpruceSchemas.Twelvebit.v2024_12_06.SaveCatValuesEmitPayload
		}

		interface SaveCatValuesEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			name: '',
			    fields: {
			            ...
			            'payload': {
			                type: 'schema',
			                isRequired: true,
			                options: {schema: SpruceSchemas.Twelvebit.v2024_12_06.SaveCatValuesEmitPayloadSchema,}
			            },
			    }
		}

		interface SaveCatValuesEmitTargetAndPayloadEntity extends SchemaEntity<SpruceSchemas.Twelvebit.v2024_12_06.SaveCatValuesEmitTargetAndPayloadSchema> {}
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface CreateCatSchema extends SpruceSchema.Schema {
			id: 'createCat',
			version: 'v2024_12_06',
			namespace: 'Twelvebit',
			name: '',
		...
		interface CreateCatEntity extends SchemaEntity<SpruceSchemas.Twelvebit.v2024_12_06.CreateCatSchema> {}
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface SaveCatValuesEmitPayload {
			
				
				'cat': SpruceSchemas.Twelvebit.v2024_12_06.CreateCat
		}

		interface SaveCatValuesEmitPayloadSchema extends SpruceSchema.Schema {
			...
			name: '',
			    fields: {
			            ...
			            'cat': {
			                type: 'schema',
			                isRequired: true,
			                options: {schema: SpruceSchemas.Twelvebit.v2024_12_06.CreateCatSchema,}
			            },
			    }
		}

		interface SaveCatValuesEmitPayloadEntity extends SchemaEntity<SpruceSchemas.Twelvebit.v2024_12_06.SaveCatValuesEmitPayloadSchema> {}
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface FeedbackeventEmitPayloadSchema extends SpruceSchema.Schema {
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface FeedbackeventResponsePayload {
			
				
				'success': boolean
		}

		interface FeedbackeventResponsePayloadSchema extends SpruceSchema.Schema {
		...
		interface FeedbackeventResponsePayloadEntity extends SchemaEntity<SpruceSchemas.Twelvebit.v2024_12_06.FeedbackeventResponsePayloadSchema> {}
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface CatSourceSchema extends SpruceSchema.Schema {
			id: 'catSource',
			version: 'v2024_12_06',
			namespace: 'Twelvebit',
			name: '',
		...
		interface CatSourceEntity extends SchemaEntity<SpruceSchemas.Twelvebit.v2024_12_06.CatSourceSchema> {}
	...
	namespace SpruceSchemas.Twelvebit.v2024_12_06 {
		...
		interface CatValues {
				...
				'source': SpruceSchemas.Twelvebit.v2024_12_06.CatSource
		}

		interface CatValuesSchema extends SpruceSchema.Schema {
			id: 'catValues',
			version: 'v2024_12_06',
			namespace: 'Twelvebit',
			name: 'Cat Values',
			    fields: {
			            ...
			            'source': {
			                type: 'schema',
			                isRequired: true,
			                options: {schema: SpruceSchemas.Twelvebit.v2024_12_06.CatSourceSchema,}
			            },
			    }
		}
